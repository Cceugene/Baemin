...
이에 따라 다음과 같이 문제를 정의 하였습니다.
1. 치밥과 타코야끼의 특성은 어떤 것이 있는가?
2. 치밥의 판매가 저조한 원인은 무엇인가?
3. 치밥의 판매를 증가시킬 방법은 무엇인가?

이러한 문제를 해결하기 위해 다음 분석을 실행했습니다.
## 문제1. 치밥과 타코야끼의 특성
### 1-1. EDA
치밥&타코야끼에 대한 분석\
[코드]()
...
## 문제3. 치밥의 판매를 증가시키기
치밥의 누린내 문제를 해결하기 위한 방향을 다음으로 나누었습니다.
1. 단골손님 늘리기
2. 고객 유실 막기

첫 번째는 주간, 점심시간대에 많이 팔리는 치밥의 특성을 이용해 새로운 고객층을 늘리는 것, 두 번째는 누린내 문제를 해결해 고객의 유실을 막는 것입니다.
